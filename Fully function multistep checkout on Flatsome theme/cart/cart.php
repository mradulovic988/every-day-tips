<div id='custom-header'><div id='custom-logo'><a href='/'><img src='/wp-content/uploads/Vault_clean_black.png'></a></div><div id='custom-email'>info@vaultcargo.com</div></div><div id='broj'><?php echo WC()->cart->get_cart_contents_count(); ?></div>
<?php
/**
 * Cart Page
 *
...
<ul class="order-process">
    <a href="<?php echo get_permalink( wc_get_page_id( 'cart' ) ); ?>">
		...
		<a>
			<li class="off">2. Customer</li>
		</a>

    <a>
			<li class="off">3. Shipping</li>
		</a>

		<a>
			<li class="off">4. Payment</li>
		</a>
</ul>
<!-- =================================================
     ========== END Order Process ====================
...
<div class="cart-collaterals large-5 col pb-0">
	...
	<div class="cart-sidebar col-inner <?php echo $sidebar_classes; ?>">
		<?php
			...
			echo '<div class="shipping_next_step"><p class="shipping_next_step_text">Shipping calculated at Shipping step.</p></div>';
		?>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) { 
		jQuery("p.shipping_next_step_text").insertBefore(".wc-proceed-to-checkout");
	});
</script>